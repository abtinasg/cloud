        ...
        <div className="w-full max-w-sm space-y-8">
            <div className="text-center md:text-left">
                ...
                <p className="mt-2 text-sm text-gray-600">
                    Sign in to access your team's cloud workspace.
                </p>
            </div>
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                autoComplete="email"
                                required
                                className="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-shadow sm:text-sm"
